...
IF EXISTS (SELECT 1 FROM sys.assembly_files WHERE [name] = 'tsqltclr')
BEGIN
    EXEC tSQLt.Uninstall
END

IF 0 = (SELECT value_in_use FROM sys.configurations WHERE name = 'clr enabled') 
BEGIN 
